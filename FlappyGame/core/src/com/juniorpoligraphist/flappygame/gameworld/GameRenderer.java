...
public class GameRenderer {
    ...
    public void render(float runTime) {
        ...
        if (myGameWorld.isReady()) {
            ...
            AssetLoader.shadow.draw(batcher, "" + myGameWorld.getScore(), (136 / 2) - (3 * score.length()), 12);
            AssetLoader.font.draw(batcher, "" + myGameWorld.getScore(), (136 / 2) - (3 * score.length() - 1), 11);
        }
